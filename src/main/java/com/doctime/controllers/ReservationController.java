...
public class ReservationController {
  ...
  public ResponseEntity<ReservationEntity> registerReservation(
    ...
    return new ResponseEntity<>(reservationRepository.save(new ReservationEntity(dataCreateReservation)),
        HttpStatus.CREATED);
  }
  ...
  @Transactional
  @PreAuthorize("hasRole('PATIENT')")
  public ResponseEntity<DataUpdateReservation> updatedReservation(
      @RequestBody @Validated DataUpdateReservation dataUpdateReservation) {
  ...
  public ResponseEntity<?> updateReservationStatus(@PathVariable Long reservationId, @RequestBody EStatus newStatus) {
    ...
    // Actualizar el estado de la reserva con el nuevo estado proporcionado en el
